# Hola, soy David Ramírez De Gante 👋
...
#### **SPIN** — *SR. Technical Lead DevOps* (Nov 2023 - Presente)
- Liderazgo de un equipo de ingenieros DevOps (incluyendo la formación, evaluación y mentoría técnica), impulsando la cultura de colaboración y metodologías ágiles.
...
- Migración integral de proyectos en EKS a nueva infraestructura y transiciones de repositorios de artefactos hacia GitHub Packages.
- Aseguramiento de alta disponibilidad con monitoreo en DataDog y CloudWatch.

#### **RackSpace** — *Cloud Engineer 4* (Mar 2022 - Feb 2023)
- Gestión de infraestructura en la nube AWS altamente compleja para clientes empresariales, garantizando el cumplimiento estricto de SLAs.
- Diseño de soluciones escalables (IaC) usando Terraform, CloudFormation y Onica Runway.
- Reconocido con el premio **RackCognition: Fanatical Learner Lv2** por la capacitación técnica brindada a clientes y al equipo.

#### **Triara.com** — *Technical Leader & Supervisor of Cloud Operations* (Nov 2016 - Mar 2022)
- Administración y soporte (2do y 3er nivel) de infraestructura cloud para plataformas empresariales B2B.
- Automatización de procesos diarios mediante desarrollo de scripts en Python, ShellScript y PHP.
- Implementación de clústeres Kubernetes *on-premises* y despliegue en entornos virtuales con VMWare.

#### **Indra** — *Sr. Linux SysAdmin* (Feb 2011 - Nov 2016)
- Administración de un entorno masivo de más de 2,000 máquinas virtuales con distribuciones empresariales Linux (RedHat, SLES, Oracle).
...
**Educación:**
- **Ingeniería en Sistemas Computacionales (Especialidad en Redes)** — Instituto Tecnológico de Querétaro (ITQ) | 2003 - 2009

**Certificaciones Destacadas:**
- 🏆 AWS Certified Solutions Architect - Professional (2022)
- 🏆 AWS Certified DevOps Engineer - Professional (2021)
- 🏅 AWS Certified SysOps (2021) & Developer - Associate (2022)
- 🏅 HashiCorp Certified: Terraform Associate (2023)
- 🐧 Linux Foundation Certified System Administrator (2017)
